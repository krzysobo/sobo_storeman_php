...
class AwsClientHelperTest extends TestCase
{
    ...
    public function testGetS3ClientWithCredentialsListNoMock()
    {
        $s3 = AwsClientHelper::getS3ClientWithAwsCredentialsList(
    ...
    public function testGetS3ClientWithCredentialsFromTokenNoMock(string $token)
    {
